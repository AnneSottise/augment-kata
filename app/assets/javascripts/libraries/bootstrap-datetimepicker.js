...
// ReSharper disable once InconsistentNaming
    DateTimePicker = function (element, options) {
        ...
        dataToOptions = function () {
            ...
            if (eData.usehours !== undefined) picker.options.useHours = eData.usehours;
            ...
            return (
                '<div class="timepicker-picker">' +
                    '<table class="table-condensed">' +
						'<tr>' +
							(picker.options.useHours ? '<td><a href="#" class="btn" data-action="incrementHours"><span class="' + picker.options.icons.up + '"></span></a></td>' : '') +
							(picker.options.useHours ? '<td class="separator"></td>' : '') +
						...
						'</tr>' +
						'<tr>' +
							(picker.options.useHours ? '<td>' + tpGlobal.hourTemplate + '</td>' : '') +
							(picker.options.useHours ? '<td class="separator">:</td>' : '') +
						...
						'</tr>' +
						'<tr>' +
						        (picker.options.useHours ? '<td><a href="#" class="btn" data-action="decrementHours"><span class="' + picker.options.icons.down + '"></span></a></td>' : '') +
							(picker.options.useHours ? '<td class="separator"></td>' : '') +
